<div class="panel panel-success ">
   ...
   <div class="panel-body">
      ...
      <div class="col-md-4">
         <div class="thumbnail">
            <a href="index.php?controller=product&amp;action=detail_product&amp;pid=<?php echo $value['masp'] ?>"><img src="asset/img/product/<?php echo $value['masp']?>.jpg" alt="" width="220" height="220"/></a>
