...
$offset = ($page -1) *$limit;
   ...
   {
   $products = $getData_model->get_from_to('sanpham',$offset,$limit,'maloai',$_GET['maloai']);
   }
   else if(isset($_GET['chatlieu']))
   {
    $products = $getData_model->get_from_to('sanpham',$offset,$limit,'macl',$_GET['chatlieu']);
   }
   else if(isset($_GET['ncc']))
   {
   $products = $getData_model->get_from_to('sanpham',$offset,$limit,'mancc',$_GET['ncc']);
   }
   else
